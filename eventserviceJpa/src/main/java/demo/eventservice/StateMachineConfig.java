...
//end::snippetC[]
    ...
    @Bean
    public StateMachinePersist<States, Events, String> stateMachinePersist(EventStateRepository eventStateRepository) {
        return new JpaStateMachinePersist(eventStateRepository);
    }

    @Bean
    public DefaultStateMachinePersister<States, Events,String> jpaStateMachinePersister(
