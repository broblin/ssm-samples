...
public class ContextObjectResourceProcessor<S, E, T extends ContextEntity<S, E, ? extends Serializable>> implements ResourceProcessor<Resource<T>> {
    ...
    public ContextObjectResourceProcessor(EntityLinks entityLinks, DefaultStateMachineAdapter<S, E, ContextEntity<S, E, ? extends Serializable>> stateMachineAdapter) {
